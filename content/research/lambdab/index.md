---
title: $\Lambda_b$ Baryon Lifetime
summary: Resolution of the $\Lambda_b$ Lifetime Puzzle
date: 2025-12-31
featured: true
weight: 20
link: /research/lambdab
...
{{< figure src="lambdab-diagram.jpg" 
           caption="Decay channel $\Lambda_b \to J\psi \Lambda^0$ for this analysis"
...
{{< figure src="lambdab-ctau.png" 
           caption="<i>Figure</i>: $c\tau$ distributions for $B^0$ (left) and $\Lambda_b$ (right)"
           class="w-full rounded-lg shadow-md mb-6" >}}

We measured

$$\tau(\Lambda_b)/\tau(B^0) = 1.041 \pm 0.057 \text{ (stat. + syst.)}$$
...
2. H.-Y. Cheng, Phenomenological Study of Heavy Hadron Lifetimes, arXiv:1807.00916 (2018)  
   [arXiv:1807.00916](https://arxiv.org/abs/1807.00916)